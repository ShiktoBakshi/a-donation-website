document.getElementById('fani-donate')
    .addEventListener('click', function(event){
        event.preventDefault();

        const money = getInputFieldValueById('fani-input');
        ...
        if(balance < money){
            ...
            const donate = getTextFieldValueById('fani-add');
            const totalDonate = donate + money;
            document.getElementById('fani-add').innerText = totalDonate;
