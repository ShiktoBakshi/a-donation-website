document.getElementById('noakhali-donate')
    .addEventListener('click', function(event){
        ...
        const money = getInputFieldValueById('noakhali-input');
        ...
        if(money < 1){
            ...
            const donate = getTextFieldValueById('noakhali-add');
            const totalDonate = donate + money;
            document.getElementById('noakhali-add').innerText = totalDonate;
